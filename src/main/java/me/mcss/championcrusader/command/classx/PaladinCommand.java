...
//                }
            ...
            // UI
                p.sendMessage(ChatColor.GREEN + "You have picked" + ChatColor.GOLD + " Paladin");
            p.sendTitle(ChatColor.GREEN + "You have picked" + ChatColor.GOLD + " Paladin","Good Luck",1,50,1);
